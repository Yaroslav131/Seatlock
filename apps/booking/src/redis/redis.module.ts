...
export class RedisModule implements OnApplicationShutdown {
   ...
   * не успело уйти по конвейеру. Особенно чувствительно для booking:
   * холды мест живут только в Redis (ADR 0003), обрыв на полпути —
   * не просто потерянное соединение, а потенциально незавершённая
   * Lua-транзакция.
   */
